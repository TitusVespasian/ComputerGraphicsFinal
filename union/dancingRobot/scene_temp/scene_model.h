...
#include "scene_temp/scene_mesh.h"
...
public:
    ...
    vector<matMesh>    meshes;
    string directory;
    bool gammaCorrection;

    // constructor, expects a filepath to a 3D model.
    matModel(string const& path, bool gamma = false) : gammaCorrection(gamma)
    {
        loadModel(path);
    }
...
private:
    ...
    matMesh processMesh(aiMesh* mesh, const aiScene* scene)
    {
        // data to fill
        ...
        return matMesh(vertices, indices, textures, mat);
    }
